...
import { PathInitializationProps, AnimationState } from './types';
...
export const usePathInitialization = ({
...
}: PathInitializationProps & { updateAnimationState: (updates: Partial<AnimationState>) => void }) => {
  
  const initializationAttemptRef = React.useRef<number>(0);
  ...
  }, [canvasReady, pathCount, pathGeneratorRef, setRenderError, updateAnimationState]);
};